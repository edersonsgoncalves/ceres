...
export default function Home() {
  ...
  if (loading) {
    return <div className="text-center text-gray-500 p-8">Carregando...</div>;
  }
  ...
  if (!data) {
    return <div className="text-center text-gray-500 p-8">Nenhum dado disponivel</div>;
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-500">Ticket Medio</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-500">Produtos Unicos</CardTitle>
          </CardHeader>
          <CardContent>
